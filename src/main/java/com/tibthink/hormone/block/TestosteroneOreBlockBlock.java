...
public class TestosteroneOreBlockBlock extends HormoneModElements.ModElement {
	@ObjectHolder("hormone:testosterone_ore_block")
	public static final Block block = null;
	public TestosteroneOreBlockBlock(HormoneModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("testosterone_ore_block");
		}
