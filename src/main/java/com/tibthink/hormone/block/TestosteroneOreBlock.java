...
import com.tibthink.hormone.item.TestosteroneDustItem;
import com.tibthink.hormone.HormoneModElements;

@HormoneModElements.ModElement.Tag
public class TestosteroneOreBlock extends HormoneModElements.ModElement {
	@ObjectHolder("hormone:testosterone_ore")
	public static final Block block = null;
	public TestosteroneOreBlock(HormoneModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("testosterone_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TestosteroneDustItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("testosterone_ore", "testosterone_ore", blockAt -> {
