...
import com.tibthink.hormone.item.EsterginItem;
import com.tibthink.hormone.HormoneModElements;

@HormoneModElements.ModElement.Tag
public class EsterginOreOreBlock extends HormoneModElements.ModElement {
	@ObjectHolder("hormone:estergin_ore_ore")
	public static final Block block = null;
	public EsterginOreOreBlock(HormoneModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("estergin_ore_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EsterginItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("estergin_ore_ore", "estergin_ore_ore", blockAt -> {
