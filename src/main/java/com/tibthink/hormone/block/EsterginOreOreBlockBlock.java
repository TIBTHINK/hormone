...
public class EsterginOreOreBlockBlock extends HormoneModElements.ModElement {
	@ObjectHolder("hormone:estergin_ore_ore_block")
	public static final Block block = null;
	public EsterginOreOreBlockBlock(HormoneModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("estergin_ore_ore_block");
		}
