...
public class TestosteroneDustItem extends HormoneModElements.ModElement {
	@ObjectHolder("hormone:testosterone_dust")
	public static final Item block = null;
	public TestosteroneDustItem(HormoneModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("testosterone_dust");
		}
